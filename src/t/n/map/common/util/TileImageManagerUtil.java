...
public class TileImageManagerUtil {
	 ...
	 */
	public static java.awt.Point getScreenCoordFromLonlat(final LonLat lonlat, final int tileNoX, final int tileNoY, final int originX, int originY, int zoomLevel) {
		double zoomLevelPow = Math.pow(2, zoomLevel);
