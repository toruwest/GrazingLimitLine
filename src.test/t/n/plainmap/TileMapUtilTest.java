...
//		assertEquals(expect, TiledMapUtil2.generateLocalFilename(savindDir, null, new LightWeightTile(17, 115843, 51898)));
//	}
//
//	@Test
//	public void testGenerateImageURI() {
//		for(int level = 0; level <= 18; level++) {
//			assertEquals(expect[level], TiledMapUtil2.generateImageURI(null, level, x[level], y[level]));
//		}
//	}
//
//	String[] expect = {
